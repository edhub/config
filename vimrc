...
" The idea of this file is to have generic configs in one file,
" so I can easily set up my VIM env in different situations.
"""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""
...
" Display"{{{
" Generic"{{{
" Set window size if it's too small
if winheight(0) < 30
    set lines=30
endif
if winwidth(0) < 100
